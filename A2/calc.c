	...
	for(i=1;i < numInputTokens;i++) 
	{
		...
		else 
		{
         ...
         /*if (sizeDynArr(stack) == 1) {
            ...
            return result;*/
         if (isNumber(s,&number) == 0) {
            printf("Not valid input! Try again, Make sure spacing is correct!\n");
         } else {
